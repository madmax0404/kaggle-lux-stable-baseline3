...
class BasePolicy(BaseModel, ABC):
    ...
    def predict(
        ...
        with th.no_grad():
            ...
            print("common policies basepolicy predict")
...
class ActorCriticPolicy(BasePolicy):
    ...
    def _build_mlp_extractor(self) -> None:
        ...
        print("common policies actorcriticpolicy _build_mlp_extractor")
    ...
    def _build(self, lr_schedule: Schedule) -> None:
        ...
        # self.optimizer = th.optim.Adam(self.parameters(), lr=lr_schedule(1), **self.optimizer_kwargs, fused=True)  # type: ignore[call-arg]
        # self.optimizer = th.optim.AdamW(self.parameters(), lr=lr_schedule(1), **self.optimizer_kwargs, fused=True, weight_decay=0.01)  # type: ignore[call-arg]
        # self.scheduler = GreedyLR(self.optimizer, factor=0.1, patience=10, cooldown=3, warmup=0, min_lr=1e-7, max_lr=5e-3, smooth=False, window=5, reset=None)
    ...
    def _predict(self, observation: PyTorchObs, deterministic: bool = False) -> th.Tensor:
        ...
        :return: Taken action according to the policy
        """
        print("actorcriticpolicy _predict")
